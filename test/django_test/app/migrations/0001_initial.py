# Generated by Django 2.0.5 on 2018-05-22 13:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CardBagID', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='CardBagID', to='app.CardBagStatic')),
            ],
        ),
        migrations.CreateModel(
            name='CatLevelStatic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TriggerToyCardBagID1', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerToyCardBagID1', to='app.CardBagStatic')),
                ('TriggerToyCardBagID2', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerToyCardBagID2', to='app.CardBagStatic')),
                ('TriggerToyCardBagID3', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerToyCardBagID3', to='app.CardBagStatic')),
                ('TriggerToyCardBagID4', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerToyCardBagID4', to='app.CardBagStatic')),
                ('TriggerToyCardBagID5', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerToyCardBagID5', to='app.CardBagStatic')),
                ('TriggerToyCardBagID6', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerToyCardBagID6', to='app.CardBagStatic')),
            ],
        ),
        migrations.CreateModel(
            name='CatSoundStatic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CatPathStatic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerGrassID', to='app.CatPathStatic')),
                ('PropDescirption', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PropDescirption', to='app.LanguageStatic')),
                ('PropName', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PropName', to='app.LanguageStatic')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NextGuideEventIDArray', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PrevGuideEventIDArray', to='app.UserGuideEventStatic')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('NextGuideID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PrevGuideID', to='app.UserGuideStatic')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='userguideeventstatic',
            name='UserGuideStatic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserGuideEvent', to='app.UserGuideStatic'),
        ),
        migrations.AddField(
            model_name='userguideconditionstatic',
            name='UserGuideStatic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='UserGuideCondition', to='app.UserGuideStatic'),
        ),
        migrations.AddField(
            model_name='dialogstatic',
            name='DialogInfo',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='DialogInfo', to='app.LanguageStatic'),
        ),
        migrations.AddField(
            model_name='dialogstatic',
            name='DialogTitle',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='DialogTitle', to='app.LanguageStatic'),
        ),
        migrations.AddField(
            model_name='dailytaskstatic',
            name='DailyTaskName',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='DailyTaskName', to='app.LanguageStatic'),
        ),
        migrations.AddField(
            model_name='costumestatic',
            name='CostumeName',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='CostumeName', to='app.LanguageStatic'),
        ),
        migrations.AddField(
            model_name='catstatic',
            name='CostumeStatic',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='CostumeMatchedCat', to='app.CostumeStatic'),
        ),
        migrations.AddField(
            model_name='catstatic',
            name='NexLevelID',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PrevLevelID', to='app.CatStatic'),
        ),
        migrations.AddField(
            model_name='cardbagstatic',
            name='CatPathStatic',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='TriggerRareCardBagID', to='app.CatPathStatic'),
        ),
    ]
